...
var RevealOnScroll = function () {
  ...
  _createClass(RevealOnScroll, [{
    ...
    value: function createWaypoints() {
      ...
      this.itemsToReveal.each(function (index, element) {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction == "down") {
              ...
              _this2.headerLinks.removeClass("is-current-link"); //deletes the class to all elements
              (0, _jquery2.default)(matchingHeaderLink).addClass("is-current-link"); //add it to there required one
            }
          },
          offset: "18%"
        });
